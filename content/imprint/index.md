...
The contents of this website are provided for information purposes only. Despite careful control, we assume no liability for the content of external links. The operators of the linked pages are solely responsible for their content.

---

### No medical advice

The information provided on this website does not constitute medical advice and is not intended to replace consultation with qualified healthcare professionals.

---

### Copyright

Unless otherwise stated, all content on this website (texts, images, and graphics) is protected by copyright and licensed under the Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International License (CC BY-NC-ND 4.0).  

Reproduction and distribution are permitted under the terms of this license. Modification, derivative works, and commercial use are not permitted without prior written consent.
...
Google Analytics 4 does not store IP addresses. IP addresses are used only temporarily and are not logged. The use of Google Analytics 4 is based on your explicit consent pursuant to Art. 6(1)(a) GDPR. Google Analytics is only activated after you have given your consent via the cookie banner. You may withdraw your consent at any time by changing your cookie settings.
